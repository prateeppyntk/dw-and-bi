...
## Data Modeling
In this project, We build 1 table and decide to extract id, login_name, type, organize, create_date, and public columns to store in the table and we also we also create_date as Cluster column and set ((id, type), create_date) as Primary key. Moreover we sort data in create_date column by descending.
